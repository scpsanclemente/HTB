...
```bash
➜  nmap sudo nmap -sS -vvv -n -Pn --min-rate 5000 -sS 10.10.10.245 -p- -oN nmapsS
Host discovery disabled (-Pn). All addresses will be marked 'up' and scan times may be slower.
Starting Nmap 7.94SVN ( https://nmap.org ) at 2024-12-03 17:02 CET
Initiating SYN Stealth Scan at 17:02
Scanning 10.10.10.245 [65535 ports]
Discovered open port 80/tcp on 10.10.10.245
Discovered open port 21/tcp on 10.10.10.245
Discovered open port 22/tcp on 10.10.10.245
Completed SYN Stealth Scan at 17:02, 13.76s elapsed (65535 total ports)
Nmap scan report for 10.10.10.245
Host is up, received user-set (0.037s latency).
Scanned at 2024-12-03 17:02:09 CET for 14s
...
Nmap done: 1 IP address (1 host up) scanned in 13.89 seconds
           Raw packets sent: 67788 (2.983MB) | Rcvd: 64477 (2.579MB)
...
|     Server: gunicorn
|     Date: Tue, 03 Dec 2024 16:02:48 GMT
|     Connection: close
...
|     HTTP/1.0 200 OK
|     Server: gunicorn
|     Date: Tue, 03 Dec 2024 16:02:41 GMT
|     Connection: close
|     Content-Type: text/html; charset=utf-8
...
|     HTTP/1.0 200 OK
|     Server: gunicorn
|     Date: Tue, 03 Dec 2024 16:02:42 GMT
|     Connection: close
|     Content-Type: text/html; charset=utf-8
...
SF-Port80-TCP:V=7.94SVN%I=7%D=12/3%Time=674F2BA1%P=x86_64-pc-linux-gnu%r(G
SF:etRequest,2F4C,"HTTP/1\.0\x20200\x20OK\r\nServer:\x20gunicorn\r\nDate:\
SF:x20Tue,\x2003\x20Dec\x202024\x2016:02:41\x20GMT\r\nConnection:\x20close
...
SF:\x2003\x20Dec\x202024\x2016:02:42\x20GMT\r\nConnection:\x20close\r\nCon
...
SF:20Tue,\x2003\x20Dec\x202024\x2016:02:48\x20GMT\r\nConnection:\x20close\
SF:r\nContent-Type:\x20text/html;\x20charset=utf-8\r\nContent-Length:\x202
